...
class TestUSQuestionBank(unittest.TestCase):
    ...
    def test_load_questions_raises_not_implemented(self):
        ...
        self.assertEqual(
            str(context.exception), "USQuestionBank.load_questions() is not implemented"
        )
    ...
    def test_load_categories_raises_not_implemented(self):
        ...
        self.assertEqual(
            str(context.exception), "USQuestionBank.load_categories() is not implemented"
        )
    ...
    def test_load_metrics_raises_not_implemented(self):
        ...
        self.assertEqual(
            str(context.exception), "USQuestionBank.load_metrics() is not implemented"
        )
